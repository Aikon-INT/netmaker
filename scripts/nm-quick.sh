...
wget -q -O /root/Caddyfile https://raw.githubusercontent.com/Aikon-INT/netmaker/v0.9.2/docker/Caddyfile
...
wget -q -O /root/docker-compose.yml https://raw.githubusercontent.com/Aikon-INT/netmaker/v0.9.2/compose/docker-compose.contained.yml
...
echo "        curl -sfL https://raw.githubusercontent.com/Aikon-INT/netmaker/v0.9.2/scripts/netclient-install.sh | sudo KEY=$ACCESS_TOKEN sh -"
echo ""
